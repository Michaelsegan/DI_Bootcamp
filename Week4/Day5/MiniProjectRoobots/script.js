let roboContainer = document.getElementById('robo-container');
...
const robots = [
    ...
    robots.forEach(el => {
      ...
      avatar.src = el.image;
      details.innerHTML = `<h2>${el.name}</h2><h2>${el.email}</h2>`;
      cards.append(avatar, details);
      roboContainer.append(cards);
